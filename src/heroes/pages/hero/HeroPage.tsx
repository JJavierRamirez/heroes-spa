...
export function HeroPage() {
  ...
  const { data: superheroData, isLoading, isError } = useHero(idSlug);
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                <Badge className={`${getCategoryColor(superheroData?.category || 'Hero')} text-white`}>
                  {superheroData?.category}
                </Badge>
                <Badge className={`${getStatusColor(superheroData?.status || 'Active')} text-white`}>{superheroData?.status}</Badge>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <Badge className={`${getStatusColor(superheroData?.status || 'Active')} text-white`}>
